...
public class XiaoBangHeader extends FrameLayout implements PtrUIHandler {
   ...
   // private View mProgressBar;
    ...
    private XBView mXBView;

    public XiaoBangHeader(Context context) {
        super(context);
        initViews(null);
    }

    public XiaoBangHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public XiaoBangHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        View header = LayoutInflater.from(getContext()).inflate(R.layout.cube_ptr_classic_default_header2, this);


        mXBView= (XBView) header.findViewById(R.id.xbView);
...
*/
    ...
    public void onUIPositionChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        ...
        Log.d("JG",ptrIndicator.getCurrentPercent()+"");
       ...
       float ratio= currentPos/frame.getHeaderHeight()*frame.getRatioOfHeaderToHeightRefresh();

        mXBView.setSweetAngle((int) (percent*360));
