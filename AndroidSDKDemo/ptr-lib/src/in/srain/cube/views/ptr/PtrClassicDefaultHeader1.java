...
public class PtrClassicDefaultHeader1 extends FrameLayout implements PtrUIHandler {
    ...
    public PtrClassicDefaultHeader1(Context context) {
        super(context);
        initViews(null);
    }
    ...
    public void setHeadTextVisibility(boolean isShow) {
        show = isShow;
        if (isShow) {
    ...
    public PtrClassicDefaultHeader1(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }
    
    public PtrClassicDefaultHeader1(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.cube_ptr_classic_default_header1, this);
        ...
        update = (TextView) header.findViewById(R.id.update);
